...
# This will review every message that end with routing key of .purchase
channel.queue_bind(exchange='routingTopic', queue=queue.method.queue, routing_key='#.purchase')
